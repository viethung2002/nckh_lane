...
from model.csnn.backbone.CSNN import SCNN  # Import mô hình SCNN từ backbone

class LaneDetectionWithCSNN(nn.Module):
    def __init__(self, in_ch=3, out_ch=2):
        ...
        """
        super(LaneDetectionWithCSNN, self).__init__()
